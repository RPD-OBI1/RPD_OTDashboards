...
savepath <- "//cor.local/RPD/OBI-Analytics/OT Dashboards/"
#fromdate <- as.Date("2017-07-01")
fromdate <- params$StartDate
todate <- Sys.Date() - 3

OT <- readRDS("//cor.local/RPD/OBI/Data/overtime/Full FY OT Data/FY0304toFY1718OTdata.RDS")
...
### [Overall money spent](file://cor.local/RPD/OBI-Analytics/OT Dashboards/Citywide/ComponentGraphs/ActivityPlotDollars.html)
...
### [Projection](file://cor.local/RPD/OBI-Analytics/OT Dashboards/Citywide/ComponentGraphs/ProjectionDollars.html)

```{r}

prop.vals <- read.csv("//cor.local/RPD/OBI/Data/overtime/CashPropVals.csv", header = T)
prop.vals.nc <- read.csv("//cor.local/RPD/OBI/Data/overtime/CashPropValsNONCUMULATIVE.csv", header = T)
...
### [Significant changes from FY 16-17 with "PersonnelShortage"](file://cor.local/RPD/OBI-Analytics/OT Dashboards/Citywide/ComponentGraphs/SigChangesPersonnelShortageDollars.html)
...
### [Significant changes from FY 16-17 with "CompletingAssignment"](file://cor.local/RPD/OBI-Analytics/OT Dashboards/Citywide/ComponentGraphs/SigChangesCompletingAssignmentDollars.html)
...
### [Significant changes from FY 16-17 with "CallBack"](file://cor.local/RPD/OBI-Analytics/OT Dashboards/Citywide/ComponentGraphs/SigChangesCallBackDollars.html)
...
### [Significant changes from FY 16-17 with "Project"](file://cor.local/RPD/OBI-Analytics/OT Dashboards/Citywide/ComponentGraphs/SigChangesProjectDollars.html)
...
### [Overall money spent by Pay Period](file://cor.local/RPD/OBI-Analytics/OT Dashboards/Citywide/ComponentGraphs/TimeByPayPeriodDollars.html)
...
### [Top Project Codes](file://cor.local/RPD/OBI-Analytics/OT Dashboards/Citywide/ComponentGraphs/TopProjectCodesDollars.html)
...
### [Hours Worked by Fiscal Year & Activity](file://cor.local/RPD/OBI-Analytics/OT Dashboards/Citywide/ComponentGraphs/ActivityPlotHours.html)
...
### [Projection](file://cor.local/RPD/OBI-Analytics/OT Dashboards/CityWide/ComponentGraphs/ProjectionInHours.html)

```{r eval}

prop.vals.hour <- read.csv("//cor.local/RPD/OBI/Data/overtime/HourPropVals.csv", header = T)
prop.vals.nc.hour <- read.csv("//cor.local/RPD/OBI/Data/overtime/HourPropValsNONCUMULATIVE.csv", header = T)
...
### [Significant changes from FY 16-17 with "PersonnelShortage"](file://cor.local/RPD/OBI-Analytics/OT Dashboards/Citywide/ComponentGraphs/SigChangesPersonnelShortageHours.html)
...
### [Significant changes from FY 16-17 with "CompletingAssignment"](file://cor.local/RPD/OBI-Analytics/OT Dashboards/Citywide/ComponentGraphs/SigChangesCompletingAssignmentHours.html)
...
### [Significant changes from FY 16-17 with "CallBack"](file://cor.local/RPD/OBI-Analytics/OT Dashboards/Citywide/ComponentGraphs/SigChangesCallBackHours.html)
...
### [Significant changes from FY 16-17 with "Project"](file://cor.local/RPD/OBI-Analytics/OT Dashboards/Citywide/ComponentGraphs/SigChangesProjectHours.html)
...
### [Overall Hours Worked by Pay Period](file://cor.local/RPD/OBI-Analytics/OT Dashboards/Citywide/ComponentGraphs/HoursWorkedByPayPeriod.html)
...
### [Top Project Codes](file://cor.local/RPD/OBI-Analytics/OT Dashboards/Citywide/ComponentGraphs/TopProjectCodesByHours.html)
